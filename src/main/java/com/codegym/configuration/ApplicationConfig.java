...
public class ApplicationConfig extends WebMvcConfigurerAdapter implements ApplicationContextAware {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/final_exam?useUnicode=true&characterEncoding=utf8");
    ...
    public void addFormatters(FormatterRegistry registry) {
        registry.addFormatter(new NationFormatter(this.applicationContext.getBean(NationService.class)));
    }
